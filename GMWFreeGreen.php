 ...
 * @ingroup Skins
 */
class SkinGMWFreeGreen extends SkinTemplate {
	/** Using gmwfreegreen. */
	var $skinname = 'gmwfreegreen', $stylename = 'gmwfreegreen',
		$template = 'GMWFreeGreenTemplate', $useHeadElement = true;
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'gmwfreegreen/960.css', 'screen' );  
		$out->addStyle( 'gmwfreegreen/gmw.css', 'screen' );
	}
}
 ...
 * @ingroup Skins
 */
class GMWFreeGreenTemplate extends QuickTemplate {
	var $skin;
	/**
		...
		<div class="header container_16">
			...
			<div class="grid_8">
                            <div class="portlet logo" id="p-logo">
                                    <a style="background-image: url(<?php  echo $wgScriptPath."/skins/gmwfreegreen/images/logo.png" ?>);" <?php
